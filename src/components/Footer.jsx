...
import { FEATURED_STYLES, FOOTER_QUICK_LINKS } from "@/lib/constant";
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-6 border-b border-border/60 pb-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <p className="caps-sm text-sm font-semibold uppercase text-primary">Pixivo Studio</p>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Show when="signed-in">
              <Button  className="gap-2 rounded-full px-5 py-3">
                <Link href="/studio" className="flex items-center gap-2" prefetch={false}>
                  Start in Studio
                  <ArrowUpRightIcon className="size-4" />
                </Link>
              </Button>
            </Show>
            <Button variant="outline"  className="rounded-full border-border/70 px-5 py-3">
