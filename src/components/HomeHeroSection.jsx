...
import { CENTER_NAV_LINKS, HERO_VIDEO_SRC } from "@/lib/constant";
      ...
      <div className="home-hero-stack">
        <nav className="hero-pill home-nav">
          ...
          <div className="home-nav-auth">
            ...
            <Show when="signed-in">
              <Button variant="outline"  className="home-btn-studio-outline">
        ...
        <div className="home-hero-copy">
          ...
          <div className="home-hero-ctas">
            ...
            <Show when="signed-in">
              <Button  className="home-btn-hero-primary">
                <Link href="/studio" prefetch={false}>
                  Open Studio
                </Link>
              </Button>
            ...
            <Button  variant="ghost" className="hero-pill home-btn-hero-ghost">
